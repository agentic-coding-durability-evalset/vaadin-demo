...
Please integrate Vaddin MCP Server to complete the login implementation.
```
...
```
Based on the wallet prototype diagram in the excalidraw file and Vaadin MCP Server, create the corresponding Vaadin View, repo classes, service classes, and entity classes, including the operation for adding expense records.
```